...
execute if score #forbiddenpeaks_mini forbiddenpeaks_mini_active matches 0 run kill @e[type=minecraft:marker,tag=spawn_forbiddenpeaks_mini,limit=1,sort=nearest]
